...
available evidence. Candidates may come from native scanner output or imported
evidence, including SonarQube, Dependency-Check, SARIF, CycloneDX, and
validated generic JSON mappings. It
